export const projects = [
  {
    ...
    github: [
      { label: 'Back-end', url: 'https://github.com/amareservir/amareservir-api' },
      { label: 'Front-end', url: 'https://github.com/amareservir/amareservir-web' },
    ],
  ...
  },
  {
    ...
    technologies: ['Java', 'React', 'PostgreSQL', 'Spring Boot'],
    github: [
      { label: 'Back-end', url: 'https://github.com/Riquelmy247/softvet-api' },
      { label: 'Front-end', url: 'https://github.com/Riquelmy247/softvet-web' },
    ],
    demoUrl: null,
  },
  {
    ...
    technologies: ['Java', 'React', 'PostgreSQL', 'Spring Boot'],
    github: [
      { label: 'Back-end', url: 'https://github.com/Riquelmy247/soldance-api' },
    ],
    demoUrl: null,
  },
  {
    ...
    github: [
      { label: 'Repositório', url: 'https://github.com/Riquelmy247/restauro-rapido' },
    ],
    demoUrl: null,
  },
  {
    ...
    github: [
      { label: 'Back-end', url: 'https://github.com/Riquelmy247/lista-conferencia' },
    ],
    demoUrl: null,
  },
  {
    ...
    github: [
      { label: 'Código', url: 'https://github.com/Riquelmy247/lash-designer' },
    ],
  ...
  },
  {
    ...
    technologies: ['React', 'Vite'],
    github: [
      { label: 'Código', url: 'https://github.com/Riquelmy247/soldance' },
    ],
  ...
  },
  {
    ...
    technologies: ['React', 'Vite'],
    github: [
      { label: 'Código', url: 'https://github.com/Riquelmy247/biocorpore' },
    ],
  ...
  },
  {
    ...
    technologies: ['React', 'Vite'],
    github: [
      { label: 'Código', url: 'https://github.com/Riquelmy247/impaccto' },
    ],
  ...
  },
  {
    ...
    github: [
      { label: 'Back-end', url: 'https://github.com/Riquelmy247/Cadastro_Dotnet' },
    ],
    demoUrl: null,
  },
  {
    ...
    github: [
      { label: 'Back-end', url: 'https://github.com/Riquelmy247/University' },
    ],
    demoUrl: null,
  },
  {
